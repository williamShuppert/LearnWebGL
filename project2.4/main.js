...
// Light data
let lightPos = new vec3(0, 0, 0)
export let lightAmbient = new vec3(.2)
export let lightDiffuse = new vec3(.8)
export let lightSpecular = new vec3(1)
...
async function main() {
    ...
    gl.uniform3f(lightColorLoc, ...lightDiffuse)
    ...
    gl.uniform3f(lightSpecularLoc, ...lightSpecular)
    ...
    function loop(time) {
        ...
        // const lightColor = getRainbowColor(time * .001).normalize()
        gl.uniform3f(lightAmbientLoc, ...lightAmbient)
        gl.uniform3f(lightDiffuseLoc, ...lightDiffuse)
        gl.uniform3f(lightSpecularLoc, ...lightSpecular)
...
export function setAmbient(ambient) {
    lightAmbient = ambient.scale(1/255)
}

export function setDiffuse(diffuse) {
    lightDiffuse = diffuse.scale(1/255)
}
